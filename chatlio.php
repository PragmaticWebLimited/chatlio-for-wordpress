	    ...
	    if ( isset ( $this->options['widget_id'] ) ) {
		    ...
		    echo '<script data-cfasync="false" type="text/javascript">
					...
					!function(){
						...
						n.id="chatlio-widget-embed",n.async=!0,n.setAttribute("data-widget-id","' . $this->options['widget_id'] . '"),n.setAttribute("data-embed-version","2.3"),n.src="https://w.chatlio.com/w.chatlio-widget.js",c.parentNode.insertBefore(n,c)
					}();
				</script>';
	    }
	}
